const HistoryInfo = ({currentAmount, label1} : {currentAmount: number, label1: string}) => {
  return (
    <div className='w-full h-auto flex justify-center items-center mt-5 mb-5'>
        <div className='border-1 border-[#2E5E8A] rounded-xl w-[90%] h-[75px]'>
            <h1 className="font-bold text-[20px] text-center"><span className="text-red-500">▲</span> Highest Usage</h1>
